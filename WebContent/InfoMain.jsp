...
<title>Main Menu</title><link href="css/bootstrap.min.css" rel="stylesheet">
...
<tr>
<td>
<input type="submit" class="btn btn-primary btn-lg btn-block" name="ACTION" value="アウト情報"><br>
</td>
</tr>
<tr><td>
<input type="submit" class="btn btn-primary btn-lg btn-block" name="ACTION" value="役満情報"  disabled="disabled"><br>
</td></tr>
<tr><td>
<input type="submit" class="btn btn-primary btn-lg btn-block" name="ACTION" value="みんなの成績"><br>
</td></tr>
<tr><td>
<input type="submit" class="btn btn-primary btn-lg btn-block" name="ACTION" value="ゲーム表　＆　入出金表"><br>
</td></tr>
<tr><td>
<input type="submit" class="btn btn-primary btn-lg btn-block" name="ACTION" value="金庫内金額参照"><br>
</td></tr>
</table>
<br>
</div>
