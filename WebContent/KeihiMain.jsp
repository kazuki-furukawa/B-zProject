...
<tr>
<td>
<input type="submit" class="btn btn-primary btn-lg btn-block" name="ACTION" value="経費使用"><br>
</td>
</tr>
<tr><td>
<input type="submit" class="btn btn-primary btn-lg btn-block" name="ACTION" value="売上取得"><br>
</td></tr>
</table>
<br>
</div>
